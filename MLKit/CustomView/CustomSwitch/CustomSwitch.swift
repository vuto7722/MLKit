...
@IBDesignable
public final class CustomSwitch: UIControl {
    
    // MARK: Public properties
    public let isOnChangeSubject = PublishSubject<Bool>()
    
    @IBInspectable public var isOn:Bool = true {
        didSet {
            isOnChangeSubject.onNext(isOn)
        }
    }
    ...
    @IBInspectable public var thumbOffTintColor: UIColor = UIColor.darkGray {
        didSet {
            self.setupUI()
        }
    }
